...
env \
  GIT_EDITOR="vim -es +$VIM_DELETE_FIRST_COMMIT_MESSAGE +$VIM_SAVE" \
  GIT_SEQUENCE_EDITOR="vim -es +$VIM_DELETE_COMMENTS +$VIM_DELETE_TWO_LAST_LINES +$VIM_PICK_TO_FIXUP +$VIM_MAKE_SQUASH_BELOW_REVERT +$VIM_SAVE" \
